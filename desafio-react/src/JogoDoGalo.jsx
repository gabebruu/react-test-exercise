        ...
        <>
          <h2> 
            <div className="vez-jogador">
              ...
              {jogo.jogadorAtual === "X" && (
                <img src="/images/gaga.jpeg" alt="Gaga" className="icone-jogador" />
              )}
              {jogo.jogadorAtual === "O" && (
                <img src="/images/alex.jpg" alt="Alex" className="icone-jogador" />
              )}
            </div>
          </h2>
        ...
        <div className="resultado-final">
          {vencedor ? (
            <div className="vencedor-container">
              ...
              {vencedor === "X" && (
                <img src="/images/gaga.jpeg" alt="Gaga" className="icone-vencedor" />
              )}
              {vencedor === "O" && (
                <img src="/images/alex.jpg" alt="Alex" className="icone-vencedor" />
              )}
            </div>
          ) : (
            <div className="vencedor-container">
